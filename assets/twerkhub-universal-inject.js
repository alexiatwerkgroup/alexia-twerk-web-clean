...
(function(){
  ...
  function loadAllJs(){
    ...
    // Magnetic cursor REMOVED 2026-04-24 — caused home lag on some machines
    // (requestAnimationFrame + elementFromPoint on every mousemove is
    // expensive on GPUs without hardware compositing). Keeping the file
    // but not loading it. If re-enabled in future, debounce mousemove.

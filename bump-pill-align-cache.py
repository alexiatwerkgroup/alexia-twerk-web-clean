...
- twerkhub-ph-theme.css : -> 20260506-p26  (vertical-centered pill via translateY -50%)
...
REPLACEMENTS = [
    ...
    (re.compile(r"(twerkhub-ph-theme\.css\?v=)[^\"'<>\s]+"),     r"\g<1>20260506-p26"),
    # pill-into-nav: p2 -> p3
...
print(f"  ph-theme    -> v=20260506-p26")

#!/usr/bin/env python3
"""gen_mc2.py - generador de paginas-por-video (rich). Escribe a /tmp/mcpages
para luego copiar con shell redirect (el mount no deja sobreescribir commiteados
via python). Uso: python3 gen_mc2.py datos.tsv
"""
import re, sys, hashlib, html, os
from pathlib import Path

ROOT = Path(__file__).resolve().parent
TEMPLATE = ROOT / "playlist" / "1-dance-twerk-choreography-pqp0uxe.html"
STAGE = Path("/tmp/mcpages")

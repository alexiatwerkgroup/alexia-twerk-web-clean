...
def gen_ld(title, url, desc, videos, is_vip=False):
    ...
    for i, v in enumerate(videos[:35], 1):
        h += f'{{"@type":"VideoObject","name":"{v["title"]}","thumbnailUrl":"https://i.ytimg.com/vi/{v["id"]}/hqdefault.jpg","contentUrl":"https://www.youtube.com/watch?v={v["id"]}","embedUrl":"https://www.youtube.com/embed/{v["id"]}","inLanguage":"en","isFamilyFriendly":false,"position":{i}}},' if i < 35 else f'{{"@type":"VideoObject","name":"{v["title"]}","thumbnailUrl":"https://i.ytimg.com/vi/{v["id"]}/hqdefault.jpg","contentUrl":"https://www.youtube.com/watch?v={v["id"]}","embedUrl":"https://www.youtube.com/embed/{v["id"]}","inLanguage":"en","isFamilyFriendly":false,"position":{i}}}'
    h += ']}}</script>'
...
def gen_itemlist(videos, is_vip=False):
    ...
    for i, v in enumerate(videos, 1):
        h += f'{{"@type":"ListItem","position":{i},"item":{{"@type":"VideoObject","name":"{v["title"]}","thumbnailUrl":"https://i.ytimg.com/vi/{v["id"]}/hqdefault.jpg","contentUrl":"https://www.youtube.com/watch?v={v["id"]}","embedUrl":"https://www.youtube.com/embed/{v["id"]}","inLanguage":"en","isFamilyFriendly":false,"isAccessibleForFree":{str(not is_vip).lower()}}}}},' if i < len(videos) else f'{{"@type":"ListItem","position":{i},"item":{{"@type":"VideoObject","name":"{v["title"]}","thumbnailUrl":"https://i.ytimg.com/vi/{v["id"]}/hqdefault.jpg","contentUrl":"https://www.youtube.com/watch?v={v["id"]}","embedUrl":"https://www.youtube.com/embed/{v["id"]}","inLanguage":"en","isFamilyFriendly":false,"isAccessibleForFree":{str(not is_vip).lower()}}}}}'
    h += ']}}</script>'
    return h

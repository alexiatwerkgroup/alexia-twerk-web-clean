...
# -*- coding: utf-8 -*-
"""
backup-v4-full.py - 2026-05-06
Backup COMPLETO del proyecto, incluyendo .git (historia completa offline).
Replica en 3 ubicaciones distintas con verificacion MD5.

Mismas 3 ubicaciones que backup-v4.py:
...
DIFERENCIA con backup-v4.py: incluye .git/ entera (~200MB extra) para air-gap
absoluto. Si GitHub se cae o tu cuenta se banea, este ZIP tiene toda la historia.

Solo excluye: node_modules, __pycache__, .DS_Store, Thumbs.db, *.pyc, *.log

Uso (corre desde la raiz del repo):
    python backup-v4-full.py
"""
